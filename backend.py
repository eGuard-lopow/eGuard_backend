...
# ------------------------------
device_list = []
device_list.append(threading.Thread(target=Device, args=[ 'octa-robin',  '493332340046001e', 0, [2,2] ]).start())
...
# device_list.append(threading.Thread(target=Device, args=[ 'foo-wesley',  '49333234002e0020', 0, [4,0] ]).start())
